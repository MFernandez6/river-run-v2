                ...
                : [
                    {
                      ...
                      content:
                        "The Board held a meeting on March 5, 2026, to discuss the additional funds necessary for the 40-year recertification and to hear residents' concerns. The HOA is actively working to address that feedback and has launched this website to keep you informed on current events, upcoming projects, and association documents.",
                      dateLabel: "March 5, 2026",
                      type: "Meeting",
                      createdAt: "",
                    },
                  ]
              ).map((announcement: { id: string; title: string; content: string; dateLabel: string; type: string }, index) => (
                <motion.div
